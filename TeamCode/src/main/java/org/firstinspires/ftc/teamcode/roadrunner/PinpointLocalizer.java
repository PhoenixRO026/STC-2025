...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 64.65772718998817; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 96.8268814149828; // x position of the perpendicular encoder (in tick units)
    }
